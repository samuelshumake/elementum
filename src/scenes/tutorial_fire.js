...
export default class tutorial_fire extends Phaser.Scene {
	...
	preload () {
		...
		this.load.tilemapTiledJSON('tutorial_fire', './assets/map/tutorial_fire.json')
	...
	create (data) {
		...
		const map = this.make.tilemap({key: 'tutorial_fire'});
